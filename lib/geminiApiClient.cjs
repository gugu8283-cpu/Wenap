 ...
 */
async function geminiApiGenerate({ userContent, maxOutputTokens = 1024, model } = {}) {
  ...
  console.log(
    `[Wenap] Gemini API generate @ ${new Date().toISOString()} model=${modelId} tokens=${usage.total_tokens}`,
  );
