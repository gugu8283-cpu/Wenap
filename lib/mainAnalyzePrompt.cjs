...
JSON schema:
{
  ...
  "criticAngles": [
    "≤32 words: skeptical angle #1 (stale data, counter-evidence, or policy gap; cite source date tag)",
    "≤32 words: skeptical angle #2 (different from riskBlindSpot; no generic disclaimers)"
  ],
