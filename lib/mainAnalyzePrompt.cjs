...
【Pro+ extra fields】Beyond Pro:
  "bullBearDebate": {
    "bull": [ { "reason": "≤36 words", "weight": "e.g. 60%" }, ...3 items ],
    "bear": [ { "reason": "≤36 words", "weight": "e.g. 40%" }, ...3 items ]
  }
...
JSON schema:
{
  ...
  "technicalSnapshot": "≤80 words; key levels as $price (source), e.g. $236.54 (120-day MA resistance)",
  "outlook": "≤120 words; aligned with horizon ${h}",
  "disclaimer": "${disc}"
}
